...
Names = {
	...
	AcrylicBorder = Color3.fromRGB(40, 60, 90),
	AcrylicGradient = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 50, 100)),
		ColorSequenceKeypoint.new(0.25, Color3.fromRGB(0, 30, 60)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(15, 15, 35)),
		ColorSequenceKeypoint.new(0.75, Color3.fromRGB(0, 10, 20)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(5, 5, 10)),
	},
	AcrylicNoise = 0.9,

	TitleBarLine = Color3.fromRGB(0, 80, 160),
	Tab = Color3.fromRGB(15, 15, 30),

	Element = Color3.fromRGB(0, 100, 180),
	ElementBorder = Color3.fromRGB(0, 60, 100),
	InElementBorder = Color3.fromRGB(10, 40, 70),
	ElementTransparency = 0.88,

	ToggleSlider = Color3.fromRGB(0, 120, 255),
	ToggleToggled = Color3.fromRGB(0, 120, 255),
	TransparenToggle = 0.6,

	SliderRail = Color3.fromRGB(0, 90, 200),

	DropdownFrame = Color3.fromRGB(0, 90, 150),
	DropdownHolder = Color3.fromRGB(0, 50, 100),
	DropdownBorder = Color3.fromRGB(0, 30, 60),
	DropdownOption = Color3.fromRGB(0, 120, 255),

	Keybind = Color3.fromRGB(0, 140, 255),

	Input = Color3.fromRGB(0, 140, 255),
	InputFocused = Color3.fromRGB(200, 200, 255),
	InputIndicator = Color3.fromRGB(0, 100, 200),
	InputIndicatorFocus = Color3.fromRGB(0, 120, 255),

	Dialog = Color3.fromRGB(0, 60, 100),
	DialogHolder = Color3.fromRGB(0, 40, 80),
	DialogHolderLine = Color3.fromRGB(0, 30, 70),
	DialogButton = Color3.fromRGB(0, 80, 160),
	DialogButtonBorder = Color3.fromRGB(0, 100, 180),
	DialogBorder = Color3.fromRGB(0, 50, 100),
	DialogInput = Color3.fromRGB(0, 70, 140),
	DialogInputLine = Color3.fromRGB(80, 130, 200),

	Text = Color3.fromRGB(220, 230, 255),
	SubText = Color3.fromRGB(180, 200, 220),
	Hover = Color3.fromRGB(0, 120, 255),
	HoverChange = 0.05,
},

Emerald = {
	Name = "Emerald",
	Accent = Color3.fromRGB(50, 180, 130),

	AcrylicMain = Color3.fromRGB(30, 45, 35),
	AcrylicBorder = Color3.fromRGB(40, 90, 60),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 55, 40), Color3.fromRGB(15, 30, 25)),
	AcrylicNoise = 0.8,

	TitleBarLine = Color3.fromRGB(55, 120, 80),
	Tab = Color3.fromRGB(75, 140, 100),

	Element = Color3.fromRGB(50, 90, 65),
	ElementBorder = Color3.fromRGB(30, 45, 35),
	InElementBorder = Color3.fromRGB(65, 110, 80),
	ElementTransparency = 0.75,

	DropdownFrame = Color3.fromRGB(80, 160, 120),
	DropdownHolder = Color3.fromRGB(30, 40, 30),
	DropdownBorder = Color3.fromRGB(20, 30, 20),

	Dialog = Color3.fromRGB(35, 45, 35),
	DialogHolder = Color3.fromRGB(20, 30, 20),
	DialogHolderLine = Color3.fromRGB(15, 25, 15),
	DialogButton = Color3.fromRGB(40, 80, 55),
	DialogButtonBorder = Color3.fromRGB(70, 140, 95),
	DialogBorder = Color3.fromRGB(55, 100, 70),
	DialogInput = Color3.fromRGB(55, 100, 70),
	DialogInputLine = Color3.fromRGB(80, 160, 120),
}
...
Solarflare = {
	...
	AcrylicMain = Color3.fromRGB(45, 25, 10),
	AcrylicBorder = Color3.fromRGB(100, 60, 30),
	AcrylicGradient = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 200, 100)),
		ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 150, 80)),
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 100, 50)),
		ColorSequenceKeypoint.new(0.75, Color3.fromRGB(200, 70, 30)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(120, 40, 20)),
	},
	AcrylicNoise = 0.88,

	TitleBarLine = Color3.fromRGB(255, 130, 60),
	Tab = Color3.fromRGB(100, 60, 40),

	Element = Color3.fromRGB(255, 100, 50),
	ElementBorder = Color3.fromRGB(160, 70, 30),
	InElementBorder = Color3.fromRGB(120, 60, 20),
	ElementTransparency = 0.82,

	ToggleSlider = Color3.fromRGB(255, 120, 0),
	ToggleToggled = Color3.fromRGB(255, 120, 0),
	TransparenToggle = 0.5,

	SliderRail = Color3.fromRGB(255, 120, 0),

	DropdownFrame = Color3.fromRGB(255, 150, 80),
	DropdownHolder = Color3.fromRGB(180, 100, 60),
	DropdownBorder = Color3.fromRGB(120, 70, 40),
	DropdownOption = Color3.fromRGB(255, 120, 0),

	Keybind = Color3.fromRGB(255, 150, 50),

	Input = Color3.fromRGB(255, 150, 50),
	InputFocused = Color3.fromRGB(255, 255, 240),
	InputIndicator = Color3.fromRGB(255, 100, 50),
	InputIndicatorFocus = Color3.fromRGB(255, 120, 0),

	Dialog = Color3.fromRGB(160, 70, 30),
	DialogHolder = Color3.fromRGB(120, 60, 30),
	DialogHolderLine = Color3.fromRGB(100, 50, 25),
	DialogButton = Color3.fromRGB(180, 80, 40),
	DialogButtonBorder = Color3.fromRGB(255, 150, 80),
	DialogBorder = Color3.fromRGB(140, 70, 35),
	DialogInput = Color3.fromRGB(190, 90, 50),
	DialogInputLine = Color3.fromRGB(255, 200, 150),

	Text = Color3.fromRGB(255, 240, 220),
	SubText = Color3.fromRGB(240, 200, 180),
	Hover = Color3.fromRGB(255, 120, 0),
	HoverChange = 0.04,
},
    ...
    Slate = {
        Name = "Slate",
        Accent = Color3.fromRGB(90, 130, 150),

        AcrylicMain = Color3.fromRGB(35, 35, 40),
        AcrylicBorder = Color3.fromRGB(60, 60, 70),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 40, 45), Color3.fromRGB(25, 25, 30)),
        AcrylicNoise = 0.91,

        TitleBarLine = Color3.fromRGB(70, 70, 75),
        Tab = Color3.fromRGB(105, 105, 110),

        Element = Color3.fromRGB(75, 75, 80),
        ElementBorder = Color3.fromRGB(30, 30, 35),
        InElementBorder = Color3.fromRGB(60, 60, 65),
        ElementTransparency = 0.81,

        DropdownFrame = Color3.fromRGB(125, 125, 130),
        DropdownHolder = Color3.fromRGB(38, 38, 44),
        DropdownBorder = Color3.fromRGB(28, 28, 33),

        Dialog = Color3.fromRGB(40, 40, 45),
        DialogHolder = Color3.fromRGB(28, 28, 33),
        DialogHolderLine = Color3.fromRGB(23, 23, 28),
        DialogButton = Color3.fromRGB(45, 45, 50),
        DialogButtonBorder = Color3.fromRGB(65, 65, 70),
        DialogBorder = Color3.fromRGB(50, 50, 55),
        DialogInput = Color3.fromRGB(50, 50, 55),
        DialogInputLine = Color3.fromRGB(125, 125, 130),
    },
    ...
    Crimson = {
        ...
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 20, 25), Color3.fromRGB(30, 10, 15)),
        AcrylicNoise = 0.85,

        TitleBarLine = Color3.fromRGB(110, 30, 40),
        Tab = Color3.fromRGB(140, 45, 55),

        Element = Color3.fromRGB(90, 30, 35),
        ElementBorder = Color3.fromRGB(50, 15, 20),
        InElementBorder = Color3.fromRGB(100, 40, 50),
        ElementTransparency = 0.85,

        DropdownFrame = Color3.fromRGB(160, 60, 70),
        DropdownHolder = Color3.fromRGB(40, 15, 20),
        DropdownBorder = Color3.fromRGB(30, 10, 15),

        Dialog = Color3.fromRGB(45, 15, 20),
        DialogHolder = Color3.fromRGB(25, 10, 15),
        DialogHolderLine = Color3.fromRGB(15, 5, 10),
        DialogButton = Color3.fromRGB(70, 25, 30),
        DialogButtonBorder = Color3.fromRGB(100, 40, 45),
        DialogBorder = Color3.fromRGB(75, 30, 35),
        DialogInput = Color3.fromRGB(75, 30, 35),
    ...
    DeepOcean = {
        ...
        AcrylicBorder = Color3.fromRGB(20, 50, 80),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 30, 50), Color3.fromRGB(5, 10, 20)),
        AcrylicNoise = 0.92,

        TitleBarLine = Color3.fromRGB(40, 90, 140),
        Tab = Color3.fromRGB(60, 130, 190),

        Element = Color3.fromRGB(40, 75, 120),
        ElementBorder = Color3.fromRGB(10, 20, 40),
        InElementBorder = Color3.fromRGB(40, 100, 160),
        ElementTransparency = 0.8,

        DropdownFrame = Color3.fromRGB(60, 140, 210),
        DropdownHolder = Color3.fromRGB(15, 35, 55),
        DropdownBorder = Color3.fromRGB(10, 20, 30),

        Dialog = Color3.fromRGB(15, 25, 35),
        DialogHolder = Color3.fromRGB(10, 15, 25),
        DialogHolderLine = Color3.fromRGB(5, 10, 20),
        DialogButton = Color3.fromRGB(30, 60, 100),
        DialogButtonBorder = Color3.fromRGB(50, 110, 170),
        DialogBorder = Color3.fromRGB(40, 90, 140),
        DialogInput = Color3.fromRGB(40, 90, 140),
        DialogInputLine = Color3.fromRGB(60, 140, 210),
    },
    ...
    MysticPurple = {
        ...
        AcrylicMain = Color3.fromRGB(40, 30, 50),
        AcrylicBorder = Color3.fromRGB(70, 50, 90),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 40, 80), Color3.fromRGB(25, 15, 40)),
        AcrylicNoise = 0.85,

        TitleBarLine = Color3.fromRGB(110, 70, 140),
        Tab = Color3.fromRGB(130, 90, 180),

        Element = Color3.fromRGB(80, 60, 100),
        ElementBorder = Color3.fromRGB(35, 25, 45),
        InElementBorder = Color3.fromRGB(65, 45, 90),
        ElementTransparency = 0.8,

        DropdownFrame = Color3.fromRGB(140, 100, 190),
        DropdownHolder = Color3.fromRGB(40, 25, 60),
        DropdownBorder = Color3.fromRGB(30, 20, 40),

        Dialog = Color3.fromRGB(45, 30, 50),
        DialogHolder = Color3.fromRGB(25, 20, 35),
        DialogHolderLine = Color3.fromRGB(15, 10, 25),
        DialogButton = Color3.fromRGB(70, 55, 110),
        DialogButtonBorder = Color3.fromRGB(100, 75, 150),
        DialogBorder = Color3.fromRGB(75, 55, 110),
        DialogInput = Color3.fromRGB(75, 55, 110),
        DialogInputLine = Color3.fromRGB(140, 100, 190),
    }
}
